...
export function RootButton({ onClick, isActive, disabled }) {
  return (
    <button
      type="button"
      onClick={onClick}
    ...
    >
      <span className={`inline-flex items-center justify-center w-6 h-6 rounded-lg
        hover:${disabled ? 'bg-gray-100' : 'bg-orange-200'}
        ${isActive ? 'bg-orange-100' : 'bg-gray-100'}
